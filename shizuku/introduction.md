...
The name Shizuku comes from [a character](https://danbooru.donmai.us/postsadb shell sh /storage/emulated/0/Android/data/moe.shizuku.privileged.api/start.sh/3553474).
